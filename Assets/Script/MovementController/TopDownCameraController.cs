...
/// Fixes jitter by:
/// 1) Running AFTER MovementController (execution order)
/// 2) Using SmoothDamp instead of Lerp
/// 3) Optional velocity look-ahead (default off)
/// </summary>
[DefaultExecutionOrder(500)] // run after MovementController (which was 200)
...
public class TopDownCameraController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (movement == null && target != null)
            movement = target.GetComponent<MovementController>();
